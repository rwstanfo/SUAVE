...
def vehicle_setup():
    ...
    turbofan.nacelle_diameter  = 1.580
    turbofan.areas             = Data()
    turbofan.areas.wetted      = 12.5*4.7*2. * Units['meter**2']  # 4.7 is outer perimeter on one side
    turbofan.origin            = [[37.,6.,-1.3],[37.,5.3,-1.3],[37.,-5.3,-1.3],[37.,-6.,-1.3]] # meters
...
#    # instantiate
#    inlet_nozzle = SUAVE.Components.Energy.Converters.Pitot_Inlet()
...
#    inlet_nozzle.areas.inlet_entrance  = 26.0
#    
#    # add to network
#    turbofan.append(inlet_nozzle)
    ...
    inlet_nozzle.areas.capture         = 24.5
    inlet_nozzle.areas.throat          = 20.0
    inlet_nozzle.areas.inlet_entrance  = 20.0
...
def mission_setup(analyses, vehicle):
    ...
    base_segment.state.unknowns.area_initial_freestream      = ones_row(1) * 24.
    base_segment.process.iterate.unknowns.network            = vehicle.propulsors.turbofan.unpack_unknowns
    base_segment.process.iterate.residuals.network           = vehicle.propulsors.turbofan.residuals    
...
#    segment.state.unknowns.area_initial_freestream = ones_row(1) * 24.
#    
