...
class Propeller(Energy_Component):
    ...
    #def spin(self,conditions):
        ...
        #va_2d = np.repeat(up[: ,np.newaxis , :], N, axis=1)
        ...
        #Ct[conditions.propulsion.throttle[:,0]  <=0.0] = 0.0
        #Ct[omega1[:,0] <=0.0] = 0.0
        #Cq[conditions.propulsion.throttle[:,0]  <=0.0] = 0.0
        #Cq[omega1[:,0] <=0.0] = 0.0
        #Cp[conditions.propulsion.throttle[:,0]  <=0.0] = 0.0
        #Cp[omega1[:,0] <=0.0] = 0.0
         
        #etap[conditions.propulsion.throttle[:,0]  <=0.0] = 0.0   
