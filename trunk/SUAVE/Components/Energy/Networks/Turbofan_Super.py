...
## @ingroup Components-Energy-Networks
class Turbofan_Super(Propulsor):
    """ This is a turbofan network with a residual for a supersonic aircraft. 
    ...
    def residuals(self,segment):
            ...
            mass_flow_rate_fan = (1 + self.bypass_ratio) * mass_flow_rate_core
            mass_flow_rate_design = mass_flow_rate_core + mass_flow_rate_fan
