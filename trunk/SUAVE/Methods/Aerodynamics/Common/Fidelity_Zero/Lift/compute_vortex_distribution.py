        ...
        if n_segments>0:            
            ...
            for i_seg in range(n_segments):   
                ...
                if wing.Segments[i_seg].Airfoil: 
                    airfoil_data = read_airfoil_geometry(wing.Segments[i_seg].Airfoil.airfoil.coordinate_file )    
            ...
            if wing.Airfoil:  
                if section.airfoil_coord_file is not None:  
                    try:  
                        airfoil_data = read_airfoil_geometry(wing.Airfoil.airfoil.coordinate_file)    
                        wing_camber  = airfoil_data.camber_coordinates
                        wing_x_coord = airfoil_data.x_lower_surface 
                    except:
                        print('Airfoil Not Located, Using uncambered wing') 
